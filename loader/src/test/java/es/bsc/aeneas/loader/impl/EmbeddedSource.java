package es.bsc.aeneas.loader.impl;

import com.yammer.metrics.Metrics;
import com.yammer.metrics.core.Gauge;
import es.bsc.aeneas.loader.DBSetter;
import es.bsc.aeneas.loader.SourceReader;
import es.bsc.aeneas.loader.exceptions.InvalidAddRequest;
import es.bsc.aeneas.loader.exceptions.InvalidPutRequest;
import es.bsc.aeneas.loader.exceptions.PatternException;
import es.bsc.aeneas.loader.exceptions.SourceReadingException;
...
public class EmbeddedSource extends SourceReader {
    ...
    public EmbeddedSource() {
        ...
        Metrics.newGauge(EmbeddedSource.class, "LineRead", new Gauge<Integer>() {
            @Override
