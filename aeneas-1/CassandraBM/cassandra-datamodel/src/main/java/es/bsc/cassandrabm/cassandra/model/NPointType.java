 ...
 */
package es.bsc.cassandrabm.cassandra.model;
 ...
 * @author cesare
 */
public class NPointType extends AbstractType<ByteBuffer> {

    public static final NPointType instance = new NPointType();
    ...
    public boolean isCompatibleWith(AbstractType<?> previous) {
        return previous instanceof NPointType;
    }
