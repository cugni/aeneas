...
package es.bsc.aeneas.workloader.query;
    ...
    extends QueryInterface
{
    ...
    @ReturnVars({
        @Var(name = "step", returnType = java.lang.Integer.class, collectionType = CollectionType.SIMPLE_TYPE),
        @Var(name = "points", returnType = es.bsc.aeneas.model.marshalling.PointType.class, collectionType = CollectionType.LIST_TYPE)
    })
    @InputVars({
        @Input(name = "number", interval = false, type = java.lang.Integer.class, from = "0", to = "1"),
     ...
     */
    @ReturnVars({
        @Var(name = "points", returnType = es.bsc.aeneas.model.marshalling.PointType.class, collectionType = CollectionType.TABLE_TYPE)
    })
    @InputVars({
     ...
     */
    @ReturnVars({
        @Var(name = "points", returnType = es.bsc.aeneas.model.marshalling.PointType.class, 
