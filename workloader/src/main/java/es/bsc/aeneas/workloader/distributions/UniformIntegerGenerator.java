 ...
 */
public class UniformIntegerGenerator extends NumberGenerator<Integer> 
{
	...
	public Integer next() 
	{
		int ret=CUtils.random().nextInt(_interval)+_lb;
		setLast(ret);
    ...
    public Integer nextInRange(Integer from, Integer maxwide) {
        return from+CUtils.random().nextInt(maxwide);
    }
