 ...
 * @author cesare
 */
public class ZipfianIntegerGeneratorTest {

    private static final Logger log = Logger.getLogger(ZipfianIntegerGeneratorTest.class.getName());
    ...
    public void testNext() {
        ...
        ZipfianIntegerGenerator zig = new ZipfianIntegerGenerator(from, to);
