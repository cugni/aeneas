...
/**
 * <p>Java class for refPathType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="level" type="{http://aeneas.bsc.es/MatchingModel}levelType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "refPathType", propOrder = {
    "level"
})
public class RefPathType
    implements Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<LevelType> theLevel;
            theLevel = (((this.level!= null)&&(!this.level.isEmpty()))?this.getLevel():null);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RefPathType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RefPathType that = ((RefPathType) object);
        {
            List<LevelType> lhsLevel;
            lhsLevel = (((this.level!= null)&&(!this.level.isEmpty()))?this.getLevel():null);
            List<LevelType> rhsLevel;
            rhsLevel = (((that.level!= null)&&(!that.level.isEmpty()))?that.getLevel():null);
